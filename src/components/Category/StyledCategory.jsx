...
export const CategoryBadge = styled.span`
  ...
  border-radius: ${(props) => {
    ...
    if (props.$variant === "minimal") return "12px";
    return "12px";
  }};
  width: ${(props) => {
    if (props.$variant === "dot") {
  ...
  text-transform: ${(props) =>
    props.$variant === "minimal" ? "none" : "none"};
  letter-spacing: ${(props) => (props.$variant === "minimal" ? "0" : "0.2px")};
...
export const CategorySelectorStyled = styled.select`
  padding: 12px 16px;
  border: none;
  border-radius: 8px;
  font-size: 14px;
